# -*- coding: utf-8 -*-
# Generated by Django 1.11 on 2017-05-04 16:06
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('feature', models.ForeignKey(db_column='feature', on_delete=django.db.models.deletion.CASCADE, to='apiary.Feature')),
                ('network', models.ForeignKey(db_column='network', on_delete=django.db.models.deletion.CASCADE, to='apiary.Network')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('node', models.ForeignKey(db_column='node', on_delete=django.db.models.deletion.CASCADE, to='apiary.Node')),
                ('sensor', models.ForeignKey(db_column='sensor', on_delete=django.db.models.deletion.CASCADE, to='apiary.Sensor')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='node',
            name='sensors',
            field=models.ManyToManyField(through='apiary.SensorSensorToNode', to='apiary.Sensor'),
        ),
